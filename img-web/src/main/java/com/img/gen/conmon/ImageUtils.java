...
public class ImageUtils {
     ...
     * @throws Exception
     */
    public static Integer convertImg(String sourceFile,String text,String color, Integer x,Integer y,Integer fontSize,String targetFile) throws  Exception{
     ...
     * @throws Exception
     */
    public static Integer convertImg(String sourceFile,String text,Integer x,Integer y,Integer fontSize,String targetFile) throws  Exception{
