...
public class GetImgUtil {
	...
	// 循环访问所有节点，输出包含关键字的值节点
		public static void extractKeyWordText(String url, String keyword) throws Exception {
			try {
...
//					String result = node.toPlainTextString();
					...
					if (result.indexOf(keyword) != -1) {
						...
						href = "http://www.doubean.com/face/" + href.substring(href.indexOf("make."), href.lastIndexOf("\"></a>"));
						...
						while (elements.hasMoreNodes()) {
							...
							if (html.indexOf("store/face") != -1) {
								int begin = html.indexOf("<img id=\"ctl00_ctl00_ContentPlaceHolder1_ContentPlaceHolder1_ImageResult\" alt=\"generated picture\" class=\"JIATHIS_IMG_OK\" src=\"") + 5;
								html = "http://www.doubean.com/face/" + html.substring(begin, html.indexOf("?c=", begin));
								String bigImgUrl = html.replace("id=\"ctl00_ctl00_ContentPlaceHolder1_ContentPlaceHolder1_ImageResult\" alt=\"generated picture\" class=\"JIATHIS_IMG_OK\" src=\"", "");
								bigImgId = String.valueOf((int)(Math.random() * 100000) + 1000000);
								downloadImg(bigImgUrl, "F:\\img\\" + bigImgId, bigImgId + "big.jpg");
							}
						}
						
						String src = "http://www.doubean.com/" + result.substring(result.indexOf("src=\"") + 6, result.lastIndexOf("\""));
	...
	public static void main(String[] args) throws Exception {
		for (int i = 1; i < 39; i ++){
			...
			extractKeyWordText(url, "<img alt=\"");
		}
		
//		//生成一个解析器对象，用网页的 url 作为参数
//		Parser parser = new Parser("http://www.doubean.com/face/make.aspx?id=1707");
//		//设置网页的编码,这里只是请求了一个 gb2312 编码网页
//		parser.setEncoding("utf-8");
//		//迭代所有节点, null 表示不使用 NodeFilter
//		NodeList detailList = parser.parse(null);
...
//			//如果html包含图片地址，下载图片 大图
//			if (html.indexOf("store/face") != -1) {
//				String bigImgUrl = "http://www.doubean.com/face/" + html.substring(html.indexOf("src=\"") + 5, html.indexOf("c=") -1 );
//				String bigImgName = IdHelper.generateShortUUID() + ".jpg";
//				downloadImg(bigImgUrl, "F:\\img\\big\\" + bigImgName);
//			}
//		}
	}
}
